...
public class SigarUtils2 {
	...
	public static void main(String... args) {
		try {
			...
			String memUsedStr = String.format("%.2f", memUsed / 1024 / 1024 / 1024) + "GB";// memto
																							// string
																							// GB
			...
			String diskUsedStr = String.format("%.2f", diskUsed / 1024 / 1024) + "GB";// disk
																						// to
																						// String
																						// GB
			...
			System.out.println("JVM的内存占比:"
					+ String.format("%.2f", (double) (r.totalMemory() - r.freeMemory()) / r.totalMemory()) + "%");
	...
	public static Sigar initSigar() {
		try {
			...
			File classPath = new File(classPath().getResource("").getPath() + "/os");
